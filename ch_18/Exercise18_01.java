...
/**
 * *18.1 (Factorial) Using the BigInteger class introduced in Section 10.9, you
 * can
 * find the factorial for a large number (e.g., 100!).
 * Implement the factorial method using recursion.
 * Write a program that prompts the user to enter an integer and displays its
 * factorial.
 */
public class Exercise18_01 {
    ...
    private static class Test {
        ...
        public static boolean testFactorial() {
            BigInteger correctResult = new BigInteger(
